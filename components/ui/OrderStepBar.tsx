        ...
        return (
          <React.Fragment key={step.label}>
            <div className="flex flex-col items-center min-w-0">
              <div
                className={["flex items-center justify-center w-7 h-7 rounded-full border-2 shadow-sm transition-all duration-200",
                  isDone
              ...
              <div
                className={["mt-2 text-sm font-semibold text-center break-words select-none transition-all duration-200 tracking-wide",
                  isDone
                    ? "text-green-600"
                    : isActive
                    ? "text-blue-700"
